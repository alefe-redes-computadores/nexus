          ...
          <div className="flex flex-wrap gap-1.5 pt-2 border-t border-zinc-800/80 mt-1">
            {task.attachments.map((file: any, idx: number) => (
              <a 
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 bg-zinc-800/80 hover:bg-zinc-700 rounded-xl text-[10px] text-indigo-300 font-medium transition-all border border-zinc-700/50"
              >
